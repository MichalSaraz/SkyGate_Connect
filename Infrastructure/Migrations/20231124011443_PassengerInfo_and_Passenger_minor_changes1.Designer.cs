...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231124011443_PassengerInfo_and_Passenger_minor_changes1")]
    partial class PassengerInfo_and_Passenger_minor_changes1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.PassengerContext.Booking.PassengerFlightDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PassengerFlightDetails");
                });
            ...
            modelBuilder.Entity("Core.PassengerContext.Booking.SpecialServiceRequest", b =>
                {
                    ...
                    b.Property<int>("PassengerFlightDetailsId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PassengerFlightDetailsId");
            ...
            modelBuilder.Entity("Core.PassengerContext.Booking.PassengerFlightDetails", b =>
                {
                    ...
                    b.HasOne("Core.PassengerContext.Passenger", "Passenger")
                        .WithMany("PassengerFlightDetails")
                        .HasForeignKey("PassengerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.PassengerContext.Booking.SpecialServiceRequest", b =>
                {
                    b.HasOne("Core.PassengerContext.Booking.PassengerFlightDetails", "PassengerFlightDetails")
                        .WithMany("SpecialServiceRequests")
                        .HasForeignKey("PassengerFlightDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PassengerFlightDetails");
            ...
            modelBuilder.Entity("Core.SeatingContext.Seat", b =>
                {
                    ...
                    b.HasOne("Core.PassengerContext.Booking.PassengerFlightDetails", "PassengerFlightDetails")
                        .WithOne("Seat")
                        .HasForeignKey("Core.SeatingContext.Seat", "PassengerFlightDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
