...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231020201710_Major_Changes_1")]
    partial class Major_Changes_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.PassengerContext.Booking.SSRCode", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("SSRCode");
            ...
            modelBuilder.Entity("Core.PassengerContext.Booking.SpecialServiceRequest", b =>
                {
                    b.HasBaseType("Core.PassengerContext.Booking.SSRCode");
                    ...
                    b.HasDiscriminator().HasValue("SpecialServiceRequest");
                });
