...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231013093315_Add_ArrivalTimes_and_FlightDuration_property")]
    partial class Add_ArrivalTimes_and_FlightDuration_property
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.FlightContext.ScheduledFlight", b =>
                {
                    ...
                    b.Property<string>("DestinationFromIATACode")
                        .HasColumnType("text");

                    b.Property<string>("DestinationToIATACode")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("DestinationFromIATACode");

                    b.HasIndex("DestinationToIATACode");
            ...
            modelBuilder.Entity("Core.FlightContext.ScheduledFlight", b =>
                {
                    ...
                    b.HasOne("Core.FlightContext.FlightInfo.Destination", "DestinationFrom")
                        .WithMany("Departures")
                        .HasForeignKey("DestinationFromIATACode");

                    b.HasOne("Core.FlightContext.FlightInfo.Destination", "DestinationTo")
                        .WithMany("Arrivals")
                        .HasForeignKey("DestinationToIATACode");
