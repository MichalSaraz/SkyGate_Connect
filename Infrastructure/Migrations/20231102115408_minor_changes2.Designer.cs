...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231102115408_minor_changes2")]
    partial class minor_changes2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.FlightContext.Flight", b =>
                {
                    ...
                    b.Property<string>("AircraftRegistrationCode")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("AircraftRegistrationCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("Core.FlightContext.Flight", b =>
                {
                    ...
                    b.HasOne("Core.FlightContext.FlightInfo.Aircraft", null)
                        .WithOne("Flight")
                        .HasForeignKey("Core.FlightContext.Flight", "AircraftRegistrationCode");
